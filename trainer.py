...
class GCL4SR_Train(Trainer):
    ...
    def train_stage(self, epoch, train_dataloader):
        ...
        for i, batch in train_data_iter:
            ...
            joint_loss, main_loss, cl_loss, ls_loss, mmd_loss = self.model.new_train_stage(batch)
        ...
        post_fix = {
            ...
            "lst_loss_avg": '{:.4f}'.format(ls_loss_avg / len(train_data_iter)),
    ...
    def eval_stage(self, epoch, dataloader, full_sort=False, test=True):
        ...
        if full_sort:
            ...
            for i, batch in rec_data_iter:
                ...
                user_ids = batch[0]
                answers = batch[2]
                recommend_output = self.model.new_eval_stage(batch)
